...
struct EditProjectView: View {
    ...
    var body: some View {
		...
		.alert(isPresented: $showingDeleteConfirm) {
			Alert(title: Text("Delete project?"), message: Text("Are you sure you want to delete? This will delete all items in project."), primaryButton: .default(Text("Delete"), action: delete), secondaryButton: .cancel())
		}
    }
